                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6 bg-white border-b border-gray-200 w-full">
                            ...
                            <div class="my-3">
                                ...
                                <x-input id="event_datetime" class="block mt-1 w-full p-2" type="datetime-local" name="event_datetime" :value="old('event_datetime')" required autofocus />
                            </div>
                            <div class="my-3">
                            ...
                            <div class="my-3">
                                <div class="flex gap-4">
                                    <label for="rsvp_control" class="inline-flex relative items-center mb-4 cursor-pointer">
                                        <input type="checkbox" value="1" id="rsvp_control" name="rsvp_control" class="sr-only peer" checked>
                                    ...
                                    <div class="flex-auto text-right">
                                        <x-input id="rsvp_timing" type="text" name="rsvp_timing" class="text-xs text-center" value="24" /> Hours
                                    </div>
                                </div>
                            ...
                            <div class="my-3">
                                <div class="flex gap-4">
                                    <label for="vote_control" class="inline-flex relative items-center mb-4 cursor-pointer">
                                        <input type="checkbox" value="1" name="vote_control" id="vote_control" class="sr-only peer" checked>
                                        <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                                        <span class="ml-3 text-sm font-medium text-gray-900">Voting Lock</span>
                                    </label>
                                    <div class="flex-auto text-right">
                                        <x-input id="vote_timing" type="text" name="vote_timing" class="text-xs text-center" value="24" /> Hours
                                    </div>
                                </div>
                        ...
                        <div class="p-6 bg-white border-b border-gray-200 w-full">
                            ...
                            <div class="my-3">
                                <label for="remind_rsvp" class="inline-flex relative items-center mb-4 cursor-pointer">
                                    <input type="checkbox" value="1" id="remind_rsvp" name="remind_rsvp" class="sr-only peer" checked>
                                    <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                            ...
                            <div class="my-3">
                                <label for="notify_vote" class="inline-flex relative items-center mb-4 cursor-pointer">
                                    <input type="checkbox" value="1" id="notify_vote" name="notify_vote" class="sr-only peer" checked>
                                    <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                            ...
                            <div class="my-3">
                                <label for="remind_break" class="inline-flex relative items-center mb-4 cursor-pointer">
                                    <input type="checkbox" value="1" name="remind_break" id="remind_break" class="sr-only peer" checked>
                                    <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
