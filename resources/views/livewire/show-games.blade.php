<div>
    ...
    <div class="columns-1 gap-3 md:columns-2 lg:columns-4" wire:loading.remove>
        @foreach($games as $game)
            <div class="max-w-sm rounded overflow-hidden shadow-sm">
                ...
                <div class="flex space-x-4 my-3">
                    <div class="bg-slate-300 rounded text-gray-500  px-2 py-1 text-sm">Plays: {{$game['numplays']}}</div>
                    <div class="bg-slate-300 rounded text-gray-500  px-2 py-1 text-sm">
